...
- `world_map.rs` now pins `globe_scene` and `srtm_focus_cache` to their single-file module paths explicitly so unfinished directory-module refactors in the working tree do not break normal builds.
